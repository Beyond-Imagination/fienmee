...
export function SearchIcon({ width, height }: IconProps) {
    return (
        <svg width={width} height={height} viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M23.8873 22.0029L19.2995 17.1988C19.0924 16.982 18.8117 16.8615 18.5172 16.8615H17.7671C19.0372 15.1606 19.7918 13.0211 19.7918 10.6938C19.7918 5.15723 15.5077 0.671143 10.2205 0.671143C4.93326 0.671143 0.64917 5.15723 0.64917 10.6938C0.64917 16.2303 4.93326 20.7164 10.2205 20.7164C12.4431 20.7164 14.4862 19.9261 16.1106 18.5962V19.3816C16.1106 19.69 16.2256 19.9839 16.4327 20.2008L21.0205 25.0049C21.453 25.4578 22.1525 25.4578 22.5804 25.0049L23.8827 23.6412C24.3152 23.1883 24.3152 22.4559 23.8873 22.0029ZM10.2205 16.8615C6.96717 16.8615 4.33045 14.1053 4.33045 10.6938C4.33045 7.28703 6.96257 4.52599 10.2205 4.52599C13.4738 4.52599 16.1106 7.28221 16.1106 10.6938C16.1106 14.1005 13.4784 16.8615 10.2205 16.8615Z"
                fill="#C8C5CC"
            />
        </svg>
    )
...
export function ArrowIcon({ width, height }: IconProps) {
    return (
        <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path stroke="grey" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
        </svg>
    )
}
...
export function CheckBoxIcon({ width, height }: IconProps) {
    return (
