...
export default function ScheduleOption({ onEdit, onDelete }: ScheduleOptionProps) {
    return (
        <Dropdown Icon={() => OptionIcon({ width: '1.5rem', height: '1.5rem' })} xTranslate={'-translate-x-20'}>
            ...
            <button className="block w-24 p-3 text-red-500 hover:bg-red-50" onClick={onDelete}>
                삭제하기
            </button>
        </Dropdown>
    )
