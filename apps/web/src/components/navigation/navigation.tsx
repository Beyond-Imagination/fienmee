    ...
    return (
        <div className="fixed flex flex-col items-center justify-center bottom-0 left-0 z-50 w-full">
            ...
            >
                ...
                <NavigationItem uri={'/events/register'} text={'행사 등록'} isClicked={false} onClick={() => setTitle('일정 등록')}>
                    <AddEventButtonIcon width={32} height={32} />
                </NavigationItem>
                <NavigationItem uri={'/events/register'} text={'내 일정'} isClicked={false} onClick={() => setTitle('행사 등록')}>
